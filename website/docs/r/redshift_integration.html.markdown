...
description: |-
  Terraform resource for managing an AWS Redshift Integration.
---
<!---
...
```console
% terraform import aws_redshift_integration.example integration-id-12345678
```
